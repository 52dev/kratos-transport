module github.com/52dev/kratos-transport/transport/nats
...
replace (
	...
	github.com/52dev/kratos-transport/broker/nats => ../../broker/nats
...
require (
	...
	github.com/52dev/kratos-transport/broker/nats v1.3.2
