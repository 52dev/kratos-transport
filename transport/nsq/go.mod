module github.com/52dev/kratos-transport/transport/nsq
...
replace (
	...
	github.com/52dev/kratos-transport/broker/nsq => ../../broker/nsq
...
require (
	...
	github.com/52dev/kratos-transport/broker/nsq v1.0.1
