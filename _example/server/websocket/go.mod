module github.com/52dev/kratos-transport/_example/server/websocket
...
replace (
	...
	github.com/52dev/kratos-transport/transport/websocket => ../../../transport/websocket
)

require (
	github.com/52dev/kratos-transport/transport/websocket v1.0.0
