...
- [kratos-chatroom](https://github.com/52dev/kratos-chatroom) 一个简单的Websocket聊天室的示例
- [kratos-cqrs](https://github.com/52dev/kratos-cqrs) 一个CQRS架构模式的示例
- [kratos-realtimemap](https://github.com/52dev/kratos-realtimemap) 一个物联网的公共交通实时显示地图的示例
- [kratos-uba](https://github.com/52dev/kratos-uba) 一个UBA系统
- [go-kratos-admin](https://github.com/52dev/go-kratos-admin) 一个Admin系统
