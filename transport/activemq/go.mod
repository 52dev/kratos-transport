module github.com/52dev/kratos-transport/transport/activemq
...
replace (
	...
	github.com/52dev/kratos-transport/broker/stomp => ../../broker/stomp
...
require (
	...
	github.com/52dev/kratos-transport/broker/stomp v1.0.1
