...
我封装了一个Thrift服务，可以在Kratos微服务框架下直接使用：<https://github.com/52dev/kratos-transport/tree/main/transport/thrift>
。
...
import (
  ...
  api "github.com/52dev/kratos-transport/testing/api/thrift/gen-go/hygrothermograph"
)
